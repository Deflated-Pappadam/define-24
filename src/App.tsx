      ...
      <AnimatePresence>
        {isLoading && (
          <motion.div
            ...
            className="fixed z-50 flex h-full w-full items-center justify-center bg-yellow bg-overlay-dark bg-blend-overlay"
          >
            <img
            ...
            <div className=" mx-auto flex w-[1000px] flex-col gap-10 py-10 md:flex-row md:justify-between ">
              ...
              <div className="why flex w-full flex-col-reverse overflow-hidden md:flex-col">
                ...
                <div className="content w-[400px] px-10">
                  ...
                  <p>
                    Define is not some random hackathon, but is a place where
                    you will build solutions for the real world. It is your
                    chance to work on impactful problem statements, build
                    collaboratively and channelize your creative mindset to come
                    up with influential yet unique ideas, all during the world’s
                    ‘realest’ hackathon.
                  </p>
                </div>
              </div>
          ...
          <section className="flex flex-col items-center justify-center bg-overlay-light">
            <div className="relative mb-5 flex h-[100px] w-[33%] flex-col justify-end  bg-overlay-light md:h-[200px]">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
                className="absolute inset-0 -z-[1] w-[101%] -translate-x-[0.5%] bg-yellow"
              />
            ...
            <div className="mt-5 flex items-center justify-between">
              <div className="flex">
                <div className="max-w-[70vw]">
                  ...
                  >
                    <b>"Build Beyond Boundaries"</b> conveys a sense of
                    ambition, innovation, and the drive to create something
                    extraordinary that transcends limitations. It's a call to
                    action for individuals and teams to think big, dream boldly,
          ...
          >
            ...
            {Object.keys(sponsorsList).map((categoryKey, cat_i) => {
              ...
              return (
                ...
                >
                  <div className="flex w-full flex-col flex-wrap items-center justify-between md:max-w-[900px] md:flex-row">
                    <div className="w-full text-center md:text-start">
                      <p className="text-xl font-black md:text-3xl">
                        {category.name}
                      </p>
                    </div>
                    <div className="flex w-full flex-wrap items-center justify-center gap-9 md:items-start md:justify-start">
